...
HEADERS = {
    'user-agent': ('Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 '
                   '(KHTML, like Gecko) Chrome/48.0.2564.109')
}
DATA_DIR = 'data'
...
class Scraper():
    ...
    def scrape_review(self, review_url):
        ...
        try:
            return self.parse_review(review_soup, review_url)
    ...
    def parse_review(self, review_soup, review_url):
    ...
    def update_scrape_status(self):
        ...
        print('{0}/{1} reviews | {2} sec elapsed | {3} sec remaining\r'.format(self.cross_process_review_count, \
            self.estimated_total_reviews, elapsed_time, time_remaining))
